...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/jean-marc-strauven/Dev/todo/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/jean-marc-strauven/Dev/todo/public/storage','logging.default','logging.deprecations.channel',
...
'broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','concurrency.default','view.paths',
...
'livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','wire-elements-modal.include_css','wire-elements-modal.include_js',
'wire-elements-modal.component_defaults.modal_max_width','wire-elements-modal.component_defaults.close_modal_on_click_away','wire-elements-modal.component_defaults.close_modal_on_escape','wire-elements-modal.component_defaults.close_modal_on_escape_is_forceful','wire-elements-modal.component_defaults.dispatch_close_event',
'wire-elements-modal.component_defaults.destroy_on_close','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'settings.password','settings.appearance','settings.locale','todos.index','todos.create',
'todos.store','todos.show','todos.edit','todos.update','todos.destroy',
...
'components.form','components.layouts.app','components.layouts.app.frontend','components.layouts.auth','components.layouts.auth.split',
'components.page-heading','components.placeholder-pattern','components.settings.layout','components.text-link','e60dd9d2c3a62d619c9acb38f20d5aa5::icon.layout-grid',
'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.loader-circle','e60dd9d2c3a62d619c9acb38f20d5aa5::navlist.group','flux.icon.layout-grid','flux.icon.loader-circle','flux.navlist.group',
...
'livewire.auth.verify-email','livewire.home','livewire.settings.appearance','livewire.settings.delete-user-form','livewire.settings.locale',
'livewire.settings.password','livewire.settings.profile','livewire::tailwind','partials.footer','partials.head',
'todos.create','todos.edit','todos.index','vendor.livewire.tailwind','volt-livewire::auth.confirm-password',
'volt-livewire::auth.forgot-password','volt-livewire::auth.login','volt-livewire::auth.register','volt-livewire::auth.reset-password','volt-livewire::auth.verify-email',
'volt-livewire::home','volt-livewire::settings.appearance','volt-livewire::settings.delete-user-form','volt-livewire::settings.locale','volt-livewire::settings.password',
'volt-livewire::settings.profile','e60dd9d2c3a62d619c9acb38f20d5aa5::accent','e60dd9d2c3a62d619c9acb38f20d5aa5::aside','e60dd9d2c3a62d619c9acb38f20d5aa5::avatar.group','e60dd9d2c3a62d619c9acb38f20d5aa5::avatar.index',
...
'laravel-exceptions::minimal','livewire-alert::components.flash','livewire-alert::components.scripts','livewire::bootstrap','livewire::simple-bootstrap',
...
'pagination::simple-tailwind','pagination::tailwind','wire-elements-modal::modal',);
...
'validation.uuid','validation.custom.attribute-name.rule-name','global.10_per_page','global.25_per_page','global.50_per_page',
'global.100_per_page','global.search_here','global.delete','global.edit','global.view',
'global.actions','global.id','global.cancel','global.this_action_is_irreversible','global.log_out',
'global.settings','global.go_to_frontend','global.save','global.saved','global.admin_dashboard',
'global.log_in','global.register','global.log_into_your_account','global.log_into_your_account_text','global.email_address',
'global.password','global.forgot_password','global.remember_me','global.dont_have_an_account','global.sign_up',
'global.forgot_password_description','global.send_password_reset_link','global.or_return_to','global.login','global.create_an_account',
'global.create_an_account_description','global.confirm_password','global.already_have_an_account','global.sign_in','global.please_confirm_your_password_before_continuing',
'global.confirm','global.reset_password','global.reset_password_description','global.please_verify_your_email_address','global.verification_link_sent',
'global.resend_verification_email','settings.title','settings.subtitle','settings.appearance','settings.update_your_settings_appearance',
'settings.light','settings.dark','settings.system','settings.delete_account_title','settings.delete_account_subtitle',
'settings.delete_are_you_sure','settings.delete_are_you_sure_text','settings.password','settings.update_password','settings.update_password_description',
'settings.current_password','settings.new_password','settings.confirm_new_password','settings.profile','settings.profile_description',
'settings.your_email_is_unverified','settings.click_here_to_request_verify','settings.verification_link_sent','users.title','users.title_description',
'users.impersonate','users.you_are_impersonating','users.stop_impersonating','users.all_roles','users.locale',
'users.locale_description','users.select_locale','users.invalid_locale','users.delete_user','users.you_are_about_to_delete',
'users.user_updated','users.user_deleted','users.name','users.email','users.roles',
'users.roles_description','users.your_full_name','users.create_user','users.create_user_description','users.edit_user',
'users.edit_user_description','users.update_user','users.user_created',);
