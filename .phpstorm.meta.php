...
'cors.max_age','cors.supports_credentials','view.paths','view.compiled','debugbar.enabled',
...
'livewire.preview-file','dashboard','profile.edit',
'profile.update','profile.destroy','todos.index','todos.create','todos.store',
'todos.show','todos.edit','todos.update','todos.destroy','register','login','password.request','password.email',
...
'profile.partials.update-password-form','profile.partials.update-profile-information-form','todos.create','todos.edit','todos.index',
